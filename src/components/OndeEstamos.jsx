        ...
        <section id="ondeestamos" className="bg-light mx-auto d-flex justify-content-center aling-items-center">
            <div id="container-ondeestamos" className="p-2 mt-4 mx-auto d-flex gap-5 flex-wrap justify-content-around aling-items-center">
                ...
                <div className="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p id="paragrafo-ondeestamos" className="p-2 mt-4 text-center">Estamos localizados na Rua Vitória da Conquista, Número 812. Os pedidos podem ser retirados ou entregues dependendo da sua necessidade. Estamos vendendo apenas garrafas, pois futuramente o salão será alugado.</p>
                </div>
                <div className="p-2">
